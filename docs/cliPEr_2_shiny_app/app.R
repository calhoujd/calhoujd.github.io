...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    fileInput(
      "file1",
      "Choose csv file | this should be the output from cliPEr_2 with functional/enrichment scores and SE",
      multiple = FALSE,
      accept = c(
        ".csv"
      )
    ...
    fileInput(
      "file2",
      "Choose csv file | this should be the dictionary file from cliPEpy_1 with variant names and k-mers",
      multiple = FALSE,
      accept = c(
        ".csv"
      )
